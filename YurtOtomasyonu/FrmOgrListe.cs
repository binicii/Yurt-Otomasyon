...
namespace YurtOtomasyonu
{
    public partial class FrmOgrListe : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurtOtomasyonuDataSet5.Ogrenci' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.ogrenciTableAdapter.Fill(this.yurtOtomasyonuDataSet5.Ogrenci);

        }
        int secilen;
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            //Öğrenci kayıt ekranındaki bilgileri kullanarak öğrenci listesine çift tık yaparak bilgileri görüntülüyoruz
